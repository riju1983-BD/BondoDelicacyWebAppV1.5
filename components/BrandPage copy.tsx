...
import { BrandData, BrandMenuCategory, RestaurantTable } from '../types';
...
const BrandPage: React.FC<BrandPageProps> = ({ brandData, onBack }) => {
    ...
    const handleAddToCart = (item: ItemData) => addItem(item);
