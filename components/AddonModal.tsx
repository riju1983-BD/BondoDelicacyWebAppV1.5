...
const AddonModal: React.FC<Props> = ({ item, onClose, onConfirm }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 w-full max-w-lg rounded-lg max-h-[90vh] overflow-y-auto relative"
        ...
        <div className="p-6 pt-4">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            disabled={
                              currentCount >= Number(group.selection_max)
                            }
          ...
          {!isValidSelection && (
            <p className="text-red-400 text-xs mt-2 text-center">
              Please meet the minimum selection requirements for all add-on
              groups
            </p>
          )}
